...
protected:
	...
	BOOL LoadStyle(const WCHAR *pwzFileName);
	BOOL LoadDLS(const WCHAR *pwzFileName);
	BOOL LoadChordMap(const WCHAR *pwzFileName);
	BOOL LoadTemplate(DWORD dwIndex, const WCHAR *pwzName);
