...
HRESULT ReadRegKey( HKEY hKey, const TCHAR* strName, TCHAR* strValue, DWORD dwLength, const TCHAR* strDefault );
HRESULT WriteRegKey( HKEY hKey, const TCHAR* strName, const TCHAR* strValue );
...
//-----------------------------------------------------------------------------
HRESULT ReadRegKey( HKEY hKey, const TCHAR* strName, TCHAR* strValue,
