...
extern VOID LoadWaveFile( HWND hDlg, const TCHAR* strFileName );
...
VOID SetStatusUI( HWND hDlg, const TCHAR* strStatus );
VOID SetFileUI( HWND hDlg, const TCHAR* strFileName );
