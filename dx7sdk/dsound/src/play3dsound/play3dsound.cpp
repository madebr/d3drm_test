...
extern VOID SetStatusUI( HWND hDlg, const TCHAR* strStatus );
extern VOID SetFileUI( HWND hDlg, const TCHAR* strFileName );
...
VOID    LoadWaveFile( HWND hDlg, const TCHAR* strFileName );
HRESULT CreateStaticBuffer( HWND hDlg, const TCHAR* strFileName );
HRESULT FillBuffer();
