...
{
    HRESULT hr;
    const char *szTemplates = "xof 0303txt 0032\
        template SimpleData { \
    ...
    hr = m_pxofapi->RegisterTemplates((LPVOID)szTemplates, strlen(szTemplates));
    ...
    if (FAILED(hr))
        std::cout << "Save templates test failed.\n";
    else
        std::cout << "Save templates test passed.\n";
...
HRESULT XOFSave::save_simple_data()
{
    ...
    if (FAILED(hr))
        std::cout << "Simple data test failed.\n";
    else
        std::cout << "Simple data test passed.\n";
...
HRESULT XOFSave::save_array_data()
{
    ...
    if (FAILED(hr))
        std::cout << "Array data test failed.\n";
    else
        std::cout << "Array data test passed.\n";
...
HRESULT XOFSave::save_optional_data()
{
    ...
    if (FAILED(hr))
        std::cout << "Restricted data test failed.\n";
    else
        std::cout << "Restricted data test passed.\n";
...
HRESULT XOFSave::save_reference_data()
{
    ...
    if (FAILED(hr))
        std::cout << "Reference data test failed.\n";
    else
        std::cout << "Reference data test passed.\n";
