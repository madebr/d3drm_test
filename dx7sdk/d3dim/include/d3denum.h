...
//-----------------------------------------------------------------------------
#define D3DENUM_SOFTWAREONLY           ((HRESULT)0x00000001) // Software-devices only flag

#define D3DENUMERR_NODIRECTDRAW        ((HRESULT)0x81000001) // Could not create DDraw
#define D3DENUMERR_ENUMERATIONFAILED   ((HRESULT)0x81000002) // Enumeration failed
#define D3DENUMERR_SUGGESTREFRAST      ((HRESULT)0x81000003) // Suggest using the RefRast
#define D3DENUMERR_NOCOMPATIBLEDEVICES ((HRESULT)0x81000004) // No devices were found that
