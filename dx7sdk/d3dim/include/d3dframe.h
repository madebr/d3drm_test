...
//-----------------------------------------------------------------------------
#define D3DFWERR_INITIALIZATIONFAILED ((HRESULT)0x82000000)
#define D3DFWERR_NODIRECTDRAW         ((HRESULT)0x82000001)
#define D3DFWERR_COULDNTSETCOOPLEVEL  ((HRESULT)0x82000002)
#define D3DFWERR_NODIRECT3D           ((HRESULT)0x82000003)
#define D3DFWERR_NO3DDEVICE           ((HRESULT)0x82000004)
#define D3DFWERR_NOZBUFFER            ((HRESULT)0x82000005)
#define D3DFWERR_INVALIDZBUFFERDEPTH  ((HRESULT)0x82000006)
#define D3DFWERR_NOVIEWPORT           ((HRESULT)0x82000007)
#define D3DFWERR_NOPRIMARY            ((HRESULT)0x82000008)
#define D3DFWERR_NOCLIPPER            ((HRESULT)0x82000009)
#define D3DFWERR_BADDISPLAYMODE       ((HRESULT)0x8200000a)
#define D3DFWERR_NOBACKBUFFER         ((HRESULT)0x8200000b)
#define D3DFWERR_NONZEROREFCOUNT      ((HRESULT)0x8200000c)
#define D3DFWERR_NORENDERTARGET       ((HRESULT)0x8200000d)
#define D3DFWERR_INVALIDMODE          ((HRESULT)0x8200000e)
#define D3DFWERR_NOTINITIALIZED       ((HRESULT)0x8200000f)
