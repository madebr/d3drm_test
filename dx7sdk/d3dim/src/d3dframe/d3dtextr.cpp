...
public:
    ...
    HRESULT LoadBitmapFile( const TCHAR* strPathname );
    HRESULT LoadTargaFile( const TCHAR* strPathname );
    HRESULT Restore( LPDIRECT3DDEVICE7 pd3dDevice );
    HRESULT CopyBitmapToSurface();
    HRESULT CopyRGBADataToSurface();

    TextureContainer( const TCHAR* strName, DWORD dwStage, DWORD dwFlags );
    ~TextureContainer();
};
...
//-----------------------------------------------------------------------------
static TextureContainer* FindTexture( const TCHAR* strTextureName )
{
...
//-----------------------------------------------------------------------------
TextureContainer::TextureContainer( const TCHAR* strName, DWORD dwStage,
                                    DWORD dwFlags )
{
...
//-----------------------------------------------------------------------------
HRESULT TextureContainer::LoadBitmapFile( const TCHAR* strPathname )
{
...
//-----------------------------------------------------------------------------
HRESULT TextureContainer::LoadTargaFile( const TCHAR* strPathname )
{
...
// Desc: Enumeration callback routine to find a best-matching texture format.
//-----------------------------------------------------------------------------
VOID D3DTextr_SetTexturePath( const TCHAR* strTexturePath )
{
...
//-----------------------------------------------------------------------------
HRESULT D3DTextr_CreateTextureFromFile( const TCHAR* strName, DWORD dwStage,
                                        DWORD dwFlags )
{
    // Check parameters
    if( NULL == strName )
...
//-----------------------------------------------------------------------------
HRESULT D3DTextr_CreateEmptyTexture( const TCHAR* strName, DWORD dwWidth,
...
//-----------------------------------------------------------------------------
HRESULT D3DTextr_DestroyTexture( const TCHAR* strName )
{
    TextureContainer* ptcTexture = FindTexture( strName );
...
//-----------------------------------------------------------------------------
LPDIRECTDRAWSURFACE7 D3DTextr_GetSurface( const TCHAR* strName )
{
    TextureContainer* ptcTexture = FindTexture( strName );
