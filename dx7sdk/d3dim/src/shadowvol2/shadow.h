...
extern VOID TransRotateVertexInX( const D3DVECTOR &transvec, FLOAT fTheta, DWORD dwCount,
                                  const D3DVERTEX* pvInVertices, D3DVERTEX* pvOutVertices );
extern VOID TransRotateVertexInY( const D3DVECTOR &transvec, FLOAT fTheta, DWORD dwCount,
                                  const D3DVERTEX* pvInVertices, D3DVERTEX* pvOutVertices );
extern VOID TransRotateVertexInZ( const D3DVECTOR &transvec, FLOAT fTheta, DWORD dwCount,
                                  const D3DVERTEX* pvInVertices, D3DVERTEX* pvOutVertices );
extern BOOL GenerateSphere( SHADOWCASTER *,const D3DVECTOR&, FLOAT, WORD, WORD,
						    FLOAT, FLOAT, FLOAT );
