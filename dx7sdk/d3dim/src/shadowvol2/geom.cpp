...
VOID TransRotateVertexInX(const D3DVECTOR &transvec, FLOAT fTheta, DWORD dwCount,
                                          const D3DVERTEX* pvInVertices, D3DVERTEX* pvOutVertices )
{
    FLOAT fSin = (FLOAT)sin(fTheta);
        FLOAT fCos = (FLOAT)cos(fTheta);
...
VOID TransRotateVertexInZ(const D3DVECTOR &transvec, FLOAT fTheta, DWORD dwCount,
                                          const D3DVERTEX* pvInVertices, D3DVERTEX* pvOutVertices )
{
    FLOAT fSin = (FLOAT)sin(fTheta);
        FLOAT fCos = (FLOAT)cos(fTheta);
...
VOID TransRotateVertexInY(const D3DVECTOR &transvec, FLOAT fTheta, DWORD dwCount,
                                          const D3DVERTEX* pvInVertices, D3DVERTEX* pvOutVertices )
{
    FLOAT fSin = (FLOAT)sin(fTheta);
        FLOAT fCos = (FLOAT)cos(fTheta);
...
//-----------------------------------------------------------------------------
BOOL GenerateSphere(SHADOWCASTER *obj,const D3DVECTOR& vCenter, FLOAT fRadius, WORD wNumRings, WORD wNumSections,
